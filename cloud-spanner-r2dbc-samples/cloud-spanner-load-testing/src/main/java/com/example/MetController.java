...
public class MetController {
  ...
  @GetMapping("/client-library-reactive")
  Flux<String> getArtworksClientLibraryReactive() {
  ...
  @GetMapping("/client-library-all")
  List<String> getArtworksClientLibraryBlocking() {
    ResultSet resultSet = this.dbClient.singleUse()
        .executeQuery(Statement.of(generateQuery()));
