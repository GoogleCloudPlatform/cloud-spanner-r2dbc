...
class DateToLocalDateConverterTest {
  ...
  void shouldConvertSuccessfully() {
    LocalDate expected = LocalDate.parse("2022-03-30");
    LocalDate actual = this.converter.convert(Date.parseDate("2022-03-30"));
  ...
  void shouldFailToConvert() {
    LocalDate expected = LocalDate.parse("2022-03-30");
    LocalDate actual = this.converter.convert(Date.parseDate("2022-03-31"));
