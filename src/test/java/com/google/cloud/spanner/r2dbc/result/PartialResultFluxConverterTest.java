...
public class PartialResultFluxConverterTest {
  ...
  public void assembleRowsTest() {
    ...
    assertThat(results.get(0).getRowMetadata().getResultSetMetadata()).isEqualTo(resultSetMetadata);
    assertThat(results.get(1).getRowMetadata().getResultSetMetadata()).isEqualTo(resultSetMetadata);
